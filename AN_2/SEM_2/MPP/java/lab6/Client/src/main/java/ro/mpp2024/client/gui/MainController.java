...
public class MainController implements IObserver {
    ...
    public void loadCurse() {
        try {
            List<CursaDTO> curseDTO = server.listDtoCurse();

            if (curseDTO == null || curseDTO.isEmpty()) {
                System.out.println("Nu există curse disponibile.");
                return;
            }
    ...
    public void loadParticipanti() {
        try {
            List<ParticipantDTO> updatedParticipants = server.findAllParticipanti();
