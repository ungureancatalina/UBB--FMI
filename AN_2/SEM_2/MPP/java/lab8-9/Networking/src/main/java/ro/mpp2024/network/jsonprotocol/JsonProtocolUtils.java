...
public class JsonProtocolUtils {
    ...
    public static Response createNewParticipantCursaResponse(ParticipantCursa participantCursa) {
        ...
        response.setParticipantCursa(new ParticipantCursa(participantCursa.getParticipant(), participantCursa.getCursa()));
        return response;
    }
    ...
    public static Request createAdaugaParticipantLaCursaRequest(ParticipantCursa participantCursa) {
        Request request = new Request();
        request.setType(RequestType.ADAUGA_PARTICIPANT_LA_CURSA);
        request.setParticipantCursa(participantCursa);
        return request;
    }
