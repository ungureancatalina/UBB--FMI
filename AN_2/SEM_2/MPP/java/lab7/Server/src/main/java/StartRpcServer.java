...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        EchipaRepositoryInterface echipaRepositoryInterface = new EchipaORMRepository();
        CursaRepositoryInterface cursaRepositoryInterface = new CursaRepository(serverProps);
        UtilizatorRepositoryInterface utilizatorRepositoryInterface = new UtilizatorORMRepository();
