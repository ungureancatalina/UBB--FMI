...
public class UtilizatorRepository : IUtilizatorRepository
{
    ...
    public Utilizator FindByNume(string nume)
    {
        ...
        {
            Console.WriteLine("Parametrul 'nume' este null sau gol.");
            return null;
        }
        ...
        {
            Console.WriteLine("Eroare în FindByNume: " + e.Message);
        }

        if (utilizator == null)
        {
            Console.WriteLine("ℹUtilizatorul cu numele '" + nume + "' nu a fost găsit.");
        }
