...
public class Console
{
    ...
    {
        utilizatorService.getUtilizator().forEach(utilizator -> {
            System.out.println("Utilizatorul: " + utilizator.getFirstName() + " " + utilizator.getLastName() + " are prietenii: ");
            utilizatorService.getListFriends(utilizator).forEach(friend -> {
    ...
    void comunitateSociabila()
    {
        ...
        List<Long> comunitate_sociabila= comunitateService.comunitateSociabila();
        comunitate_sociabila.forEach(System.out::println);
